<?php
  ...
  if(isset($_POST['izmeni'])){
    ...
    if($konekcija->query("UPDATE prijava set brojPoena =  $ocena where brojKandidata = '$brIndeksa' and predmetID=$prID and rokID=$rID")){
        ...
        <div class="container">
            ...
            <form method="post" action="">
              ...
              <label for="student">Kandidat</label>
                ...
                <input type="submit" value="Sačuvaj kandidata" name="sacuvaj" class="btn btn-primary margin-top-10">
				<br>
              </form>
